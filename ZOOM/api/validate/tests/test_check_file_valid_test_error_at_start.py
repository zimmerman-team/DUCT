...
class FileValidTestCase(TestCase):
    ...
    def test_check_file_valid_test_error_at_start(self):

        with open('samples/check_file_valid_test_error_at_start.csv') as fp:
                res_file_upload = self.c.post(
                        ...
                        'file_name': 'check_file_valid_test_error_at_start.csv',
                        })
