...
class FileValidTestCase(TestCase):
    ...
    def test_check_file_valid_test_text_at_end_of_file(self):

        with open('samples/check_file_valid_test_text_at_end_of_file.csv') as fp:
                res_file_upload = self.c.post(
                        ...
                        'file_name': 'check_file_valid_test_text_at_end_of_file.csv',
                        })
