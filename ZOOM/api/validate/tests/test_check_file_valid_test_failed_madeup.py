...
class FileValidTestCase(TestCase):
    ...
    def test_check_file_valid_test_failed_madeup(self):

        with open('samples/check_file_valid_test_failed.madeup') as fp:
                res_file_upload = self.c.post(
                        ...
                        'file_name': 'check_file_valid_test_failed.madeup',
                        })
        ...
        self.assertEquals(res_check_file_valid.json()['error'], "Don't recognise file type")
