...
class FileValidTestCase(TestCase):
    ...
    def test_check_file_valid_test_failed_xlsx(self):

        with open('samples/check_file_valid_test_failed.xlsx') as fp:
                res_file_upload = self.c.post(
                        ...
                        'file_name': 'check_file_valid_test_failed.xlsx',
                        })
        ...
        self.assertEquals(res_check_file_valid.json()['error'], "Cannot map xlsx files")
