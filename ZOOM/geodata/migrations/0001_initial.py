    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iso3', models.CharField(blank=True, max_length=3,
                                          null=True)),
                ('numerical_code_un', models.IntegerField(blank=True,
                                                          null=True)),
                ('dac_country_code', models.IntegerField(blank=True,
                                                         null=True)),
                ('center_longlat',
                 django.contrib.gis.db.models.fields.PointField(blank=True,
                                                                null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type',
                 models.CharField(choices=[('country', 'country'),
                                           ('region', 'region'),
