...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='File',
            fields=[
                ('file_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ...
                ('mapping_used', django.contrib.postgres.fields.jsonb.JSONField()),
        ...
        migrations.CreateModel(
            name='FileSource',
            fields=[
                ('file_source_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
