...
def upload_to(instance, filename='test'):
    return os.path.join(
        os.path.join(settings.MEDIA_ROOT, settings.DATASETS_URL), filename)
...
HAVE_TESTED_CHOICES = (('0', 'No'), ('1', 'Yes'), ('2', 'Don\'t know'))

WHO_TESTED_CHOICES = (('1', 'Enumerators'), ('2', 'Colleagues'),
                      ('3', 'Respondents'),
                      ('4', 'Representative group of respondents'))

CONSINDERED_SENSITIVE_CHOICES = (('0', 'No'), ('1', 'Yes'), ('2',
                                                             'Don\'t know'))

CLEANING_TECHNIQUES_CHOICES = (('0', 'Other'), ('1', 'Check for outliers'),
...
class File(models.Model):
    ...
    survey_data = models.ForeignKey(SurveyData,
                                    related_name='file',
                                    null=True,
    ...
    def get_file_path(self):
        return os.path.join(settings.MEDIA_ROOT, settings.DATASETS_URL,
